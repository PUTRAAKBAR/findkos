  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 py-12 md:px-12 lg:px-24 bg-background">
        <Link href="/" className="inline-flex items-center gap-2 mb-8 text-foreground hover:text-primary transition-colors">
        ...
        <div className="max-w-md w-full mx-auto space-y-8">
          <div>
            <h1 className="text-3xl font-bold tracking-tight mb-2">Daftar Akun Baru</h1>
            <p className="text-muted-foreground">
              Bergabunglah dengan FINDKOS untuk mulai mencari atau menyewakan properti Anda.
            </p>
          </div>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="text-sm text-muted-foreground">
              Dengan mendaftar, Anda menyetujui <Link href="#" className="text-primary hover:underline">Syarat & Ketentuan</Link> serta <Link href="#" className="text-primary hover:underline">Kebijakan Privasi</Link> kami.
            </div>
      ...
      <div className="hidden md:block relative bg-muted order-first md:order-last">
        <img 
          src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=1400&auto=format&fit=crop" 
          alt="Daftar illustration" 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent flex flex-col justify-end p-12 lg:p-24">
          ...
          <p className="text-white/90 text-lg max-w-lg">
            Buat akun dalam hitungan detik. Rasakan kemudahan mencari hunian atau mulai pasarkan properti Anda ke ribuan mahasiswa.
          </p>
        </div>
      </div>
    </div>
